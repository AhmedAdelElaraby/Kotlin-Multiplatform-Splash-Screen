...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kotlin_multiplatform_splash_screen.composeapp.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/kotlin_multiplatform_splash_screen.composeapp.generated.resources/" +
      path)
